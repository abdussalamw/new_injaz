    ...
    <div class="card-body d-flex flex-column position-relative">
        ...
        <div class="mt-auto">
            ...
            <div class="d-flex flex-column" style="gap: 0.5rem;">
                <!-- Row 1: Details & WhatsApp -->
                <div class="d-flex justify-content-between align-items-center w-100">
                    <?php if (has_card_permission('task_card_edit', $conn)): ?>
                        <a href="edit_order.php?id=<?= $task_details['order_id'] ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-pencil-square"></i> تفاصيل</a>
                    <?php else: ?>
                ...
                <div class="d-flex flex-wrap justify-content-start" style="gap: 0.5rem;">
                    <?php foreach ($actions as $action_key => $action_details): ?>
                        ...
                        <?php elseif ($action_key === 'confirm_payment'): ?>
